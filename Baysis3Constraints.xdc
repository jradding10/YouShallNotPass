...
set_property PACKAGE_PIN R2 [get_ports {create}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {create}]
...
#set_property PACKAGE_PIN U14 [get_ports {P1[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {P1[0]}]
#set_property PACKAGE_PIN V14 [get_ports {P1[1]}]					
...
#set_property PACKAGE_PIN W3 [get_ports {z[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {z[0]}]
#set_property PACKAGE_PIN U3 [get_ports {z[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {z[1]}]
#set_property PACKAGE_PIN P3 [get_ports {z[2]}]					
...
set_property PACKAGE_PIN T18 [get_ports EN]						
    set_property IOSTANDARD LVCMOS33 [get_ports EN]
#set_property PACKAGE_PIN W19 [get_ports BT0]						
